...
export default function OrdersTable({
    ...
    // ⚡ CRITICAL: Memoize columns để tránh re-create mỗi render (300ms+ delay!)
    const columns = useMemo<ColumnsType<Order>>(() => [
        ...
        },
        {
            ...
            width: 140,
            align: "center",
            render: (_, record: Order) => <OrderStatusBadge status={record.status} />,
        },
        {
            title: "Thanh toán",
            key: "paymentStatus",
    ...
    ], [onView, onUpdateStatus, onCancel]); // ← Chỉ re-create khi callbacks thay đổi
